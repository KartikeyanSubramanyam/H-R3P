...
hospital_names = df2['Hospital Name'].values
hospital_coords = df2[['Latitude', 'Longitude']].values
...
hospital_proximity.to_csv('filtered_AHA_OpenCellID_analysis_section2', index=False)