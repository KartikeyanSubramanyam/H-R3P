...
hospital_names = df3['Hospital Name'].values
hospital_coords = df3[['Latitude', 'Longitude']].values
...
hospital_proximity.to_csv('filtered_AHA_OpenCellID_analysis_section3', index=False)