...
hospital_names = df4['Hospital Name'].values
hospital_coords = df4[['Latitude', 'Longitude']].values
...
hospital_proximity.to_csv('filtered_AHA_OpenCellID_analysis_section4', index=False)